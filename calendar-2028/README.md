...
Статический календарь на 2028 год: одна HTML-страница, CSS-оформление и JavaScript, который строит все 12 месяцев и выделяет праздничные дни России.
...
Тест проверяет, что 2028 год високосный, февраль содержит 29 дней, год содержит 366 дней, январь начинается с субботы при неделе с понедельника, а список российских праздников содержит ожидаемые даты.
